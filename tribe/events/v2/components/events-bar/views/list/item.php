...
?>
<div class="<?php echo esc_attr( implode( ' ', $list_item_classes ) ); ?>">
	<a
	...
	>
		...
		<span class="tribe-events-c-view-selector__list-item-text">
            <?php $view_label_text = esc_html( $public_view_data->view_label ); ?>
            <?php echo ($view_label_text === 'Month') ? 'Calendar View' : 'List View'; ?>
		</span>
	</a>
</div>